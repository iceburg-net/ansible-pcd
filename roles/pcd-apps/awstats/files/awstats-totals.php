 ...
 * @copyright   2004-2011 Telartis BV
 * @version     1.18
 *
...
$rs = mysql_query($sql);
if ($rs) while ($row = db_fetch_array($rs))
...
href="http://www.telartis.nl/xcms/awstats">&copy; 2004-2011 Telartis BV</a></center><br><br>
